...
<div><span><b>00 · POLYMATH-AI</b> · MOBILE LLM TRAINING</span> <span>RESEARCH-READY · PHONE COMPILE OPEN</span></div>
      <h1>Polymath LLM Training <span>On Mobile Phone</span></h1>
...
<div><b>02 · MARKETS</b> <span>USER FIT</span></div>
      <div>
        <div>
          <div><span>Research infra teams</span>  <span>best fit</span></div>
          <div><span>Mobile runtime teams</span>  <span>adjacent</span></div>
          <div><span>Corpus &amp; license ops</span>  <span>open</span></div>
          <div><span>Production edge AI</span>  <span>not now</span></div>
          <div><span>Consumer apps</span>  <span>not now</span></div>
        </div>
      </div>
...
<div><b>05.2 · BENCHMARKS</b> <span>HOST HARNESS</span></div>
      <div>
        ...
        <div>
          <div><span>Host harness</span>  <span>pass</span></div>
          <div><span>Frozen middle</span>  <span>0 changes</span></div>
          <div><span>Phone compile</span>  <span>unsupported</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE &middot; HOST VS DEVICE STATUS</b></div>
      <div>
        <div>
          <div><span>Host harness</span>  <span>reported pass</span></div>
          <div><span>QNN/LiteRT compile</span>  <span>unsupported</span></div>
          <div><span>Device telemetry</span>  <span>open</span></div>
          <div><span>Licensed corpus</span>  <span>open</span></div>
        </div>
      </div>
