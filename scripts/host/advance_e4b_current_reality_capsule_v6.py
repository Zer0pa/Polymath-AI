#!/usr/bin/env python3
"""Execute the reviewed Gemma 4 E4B current-reality v5 -> v6 CAS."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Atomically advance the exact governing capsule v5 to v6."
    )
...
def main() -> int:
    args = parse_args()
    try:
        result = advance_capsule_v5_to_v6(
