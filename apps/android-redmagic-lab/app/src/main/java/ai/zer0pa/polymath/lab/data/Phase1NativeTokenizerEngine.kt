...
class Phase1NativeTokenizerEngine(
    ...
    private fun appRunResult(
        ...
        return JSONObject()
            ...
            .put("distinct_token_ids", nativeProbe.optLong("distinct_token_ids", 0))
            .put("vocab_size", nativeProbe.optLong("vocab_size", 0))
            .put("vocab_coverage_ratio", nativeProbe.optDouble("vocab_coverage_ratio", 0.0))
            .put("tokens_per_record_mean", nativeProbe.optDouble("tokens_per_record_mean", 0.0))
            .put("tokens_per_record_p50", nativeProbe.optDouble("tokens_per_record_p50", 0.0))
            .put("tokens_per_record_p95", nativeProbe.optDouble("tokens_per_record_p95", 0.0))
            .put("tokens_per_record_p99", nativeProbe.optDouble("tokens_per_record_p99", 0.0))
            .put("tokens_per_record_distribution_source", nativeProbe.optString("tokens_per_record_distribution_source", "pqa1_record_headers"))
